...
// Aqui obtenemos obtenemos la validacon si este usario ah bloqueado al contacto del chatId que se pasa como valor 

// GET /contact/blocks/?contactUserId=${contactUserId}&blockStatus=${blockStatus}&chatId=${chatId}
router.get('/contact/blocks', authenticate, authorize, async (req, res) => {
...
// POST /blocks/
router.post('/blocks', authenticate, authorize, async (req, res) => {
