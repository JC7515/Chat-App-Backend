...
// /groups/
router.get('/groups', authenticate, authorize, async (req, res) => {
...
// /groups/
router.post('/groups', authenticate, authorize, async (req, res) => {
...
router.delete('/groups', authenticate, authorize, async (req, res) => {
